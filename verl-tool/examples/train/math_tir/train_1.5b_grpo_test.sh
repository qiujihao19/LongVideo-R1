set -x
dataset_name=/home/QiuJihao/Workspace/RL/latest_code/qwen3_code/data/deepmath # or math_torl_offical to use torl training data
train_data=${dataset_name}/train.parquet
val_data=${dataset_name}/test.parquet
model_name=/media/Disk3/QiuJihao/checkpoint/Qwen/Qwen2.5-Math-1.5B
