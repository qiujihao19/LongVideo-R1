...
tool_config_path="abs/verl-tool/verl_tool/servers/tool_init_config.example.json"
...
python -m verl_tool.servers.serve --host $host --port $port --tool_type "get_caption" --workers_per_tool 8 --tool_config_path $tool_config_path &
server_pid=$!
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 PYTHONUNBUFFERED=1 python3 -m verl_tool.trainer.main_ppo \
