...
def process_single_row(row, current_split_name, row_index):
    ...
    high_caption = caption['captions'][1]
    ...
    # Process data source
    data_source_tagged = "videocaption_videomme"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Process LongVideo-R1 rl val data to training data.")
    parser.add_argument(
        "--data_dir", help="The directory of LongVideo-R1 valdation data."
    )
    parser.add_argument(
        "--local_dir",
