...
def agent_compute_data_metrics(batch: DataProto, use_critic: bool = True) -> Dict[str, Any]:
    ...
    # if 'reward_extra_info/answer_reward' in batch.non_tensor_batch:
    #     metrics['reward/answer_reward/mean'] = float(np.array(batch.non_tensor_batch['reward_extra_info/answer_reward'], dtype=np.float32).mean())
    #     metrics['reward/f1_reward/mean'] = float(np.array(batch.non_tensor_batch['reward_extra_info/f1_reward'], dtype=np.float32).mean())
    #     metrics['reward/repeat_reward/mean'] = float(np.array(batch.non_tensor_batch['reward_extra_info/repeat_reward'], dtype=np.float32).mean())
