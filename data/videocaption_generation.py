...
def parse_args():
    ...
    parser.add_argument('--api_key', type=str, required=True, help='Your local Qwen API key, e.g. 11111')
    parser.add_argument('--base_url', type=str, required=True, help='Your Qwen API base url, e.g. http://127.0.0.1:8000/v1')
